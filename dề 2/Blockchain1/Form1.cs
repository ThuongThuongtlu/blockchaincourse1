...
namespace Blockchain1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            text1 = truocbam.Text.Trim();
            var sha256HashedMessage = Hashing.ComputeHashSha256(Encoding.UTF8.GetBytes(text1));
            string signature = Convert.ToBase64String(DigSign.SignData(sha256HashedMessage));
            if (signature == chukyso.Text.Trim())
        ...
        {
            string a = input.Text.Trim();
            byte[] encrypted;
            var data = Encoding.UTF8.GetBytes(a);
            encrypted = DigSign.Encrypt(data);
            output.Text = Convert.ToBase64String(encrypted);
        }
        ...
        private void btnDecode_Click(object sender, EventArgs e)
        {
            ...
            deoutput.Text = Encoding.UTF8.GetString(DigSign.Decrypt(data));
